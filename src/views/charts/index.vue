<template>
  <div class="charts">
    ...
    <el-row :gutter="15">
      <el-col :span="8">
        <LineChart :eData="lineData1" />
      </el-col>
      <el-col :span="8">
        <LineChart :eData="lineData2" />
      </el-col>
      <el-col :span="8">
        <LineChart :eData="lineData3" />
      </el-col>
    </el-row>
    <el-row :height="500"
      ><el-col> <LineChartJson /> </el-col
    ></el-row>
    <h3>柱状图</h3>
    <el-row :gutter="15">
      <el-col :span="8">
        <BarChart :eData="barData1" />
      </el-col>
      <el-col :span="8">
        <BarChart :eData="barData2" />
      </el-col>
      <el-col :span="8">
        <BarChart :eData="barData3" />
      </el-col>
    </el-row>
    <el-row>
      <el-col>
        <BarChart :eData="barData4" />
      </el-col>
    </el-row>
    <h3>饼状图</h3>
    <el-row :gutter="15">
      <el-col :span="8">
        <PieChart :eData="pieData1" />
      </el-col>
      <el-col :span="16">
        <PieChart :eData="pieData2" />
      </el-col>
    </el-row>
  </div>
</template>
